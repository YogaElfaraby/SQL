                        ...
                        <div class="card-body">
                            <form action="/dashboard/{{$tasks->id}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Nama" name="name" value="{{$tasks->name}}">
                                </div>
                                <div class="form-group">
                                    <label for="time">start time</label>
                                    <input type="datetime-local" class="form-control" name="start_time" value="{{$tasks->start_time}}">
                                </div>
                                <div class="form-group">
                                    <label for="time">end time</label>
                                    <input type="datetime-local" class="form-control" name="end_time" value="{{$tasks->end_time}}">
                                </div>
